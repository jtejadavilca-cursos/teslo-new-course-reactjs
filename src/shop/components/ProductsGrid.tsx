...
export const ProductsGrid = ({ products }: Props) => {
    const { getStringUrlParamOrDefault, setUrlParam } = useCustomSearchParams();
    const viewMode = getStringUrlParamOrDefault("viewMode", "grid");

    const [showFilters, setShowFilters] = useState(false);

    const handleViewModeChange = (mode: string) => {
        setUrlParam("viewMode", mode === "grid" ? "" : mode);
    };
